...
* <details>
  <summary>generate [code](assets/cursor-code-gen.png) for adding the picture</summary>

  ![Code Generation](assets/cursor-code-gen.png)

  </details>
* <details>
  <summary>visualize the [codebase](assets/cursor-codebase-diagram.png)</summary>

  ![Codebase Diagram](assets/cursor-codebase-diagram.png)

  </details>
* <details>
  <summary>explain its overall [logic](assets/cursor-code-logic.png)</summary>

  ![Code Logic](assets/cursor-code-logic.png)
